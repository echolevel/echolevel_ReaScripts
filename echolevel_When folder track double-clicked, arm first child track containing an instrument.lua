--[[
When a folder track is double-clicked, arm the first found child track that contains an instrument.
I call this via a mouse modifier (double clicking on TCP)
]]
